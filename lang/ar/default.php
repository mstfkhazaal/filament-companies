...
return [
    ...
    'role' => [
        'admin' => [
            'title' => 'إداري',
            'subtitle' => 'يمكن للمستخدمين المسؤولين تنفيذ أي إجراء.',
        ],
        'editor' => [
            'title' => 'محرر',
            'subtitle' => 'يتمتع مستخدمو المحرر بالقدرة على القراءة والإنشاء والتحديث.',
        ],
    ],
    'subheadings' => [
        'auth' => [
        ...
        'companies' => [
            ...
            'delete_company' => 'بمجرد حذف الشركة، سيتم حذف جميع الموارد والبيانات الخاصة بها بشكل دائي. قبل حذف هذه الشركة، يرجى تنزيل أي بيانات أو معلومات ترغب في الاحتفاظ بها.',
        ],
    ],
];
